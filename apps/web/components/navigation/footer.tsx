...
export function Footer() {
  return (
    <footer className="mt-rhythm-xl border-t border-border bg-surface/50 md:mt-rhythm-2xl">
      <Container
        size="page"
        className="py-rhythm-xl pb-[max(var(--spacing-rhythm-xl),env(safe-area-inset-bottom))] md:py-rhythm-2xl md:pb-[max(var(--spacing-rhythm-2xl),env(safe-area-inset-bottom))]"
      >
        <Stack gap="lg" className="md:gap-rhythm-xl">
          <Stack gap="md" className="max-w-prose">
            ...
            <Body tone="secondary">{PLATFORM_POSITIONING.tagline}</Body>
            <a
          ...
          <div
            className="flex flex-col gap-rhythm-md md:grid md:grid-cols-[minmax(9rem,11rem)_1fr] md:items-start md:gap-x-rhythm-lg md:gap-y-0 lg:grid-cols-[12rem_1fr] lg:gap-x-rhythm-xl"
          >
            <nav className="hidden space-y-rhythm-sm md:block">
            ...
            <div className="grid grid-cols-1 gap-rhythm-md lg:grid-cols-3 lg:gap-rhythm-lg">
              {EXPERTISE_NAVIGATION_GROUPS.map((group) => (
                <nav className="space-y-rhythm-sm" key={group.label}>
                  <Caption tone="accent" className="text-xs uppercase tracking-wider">
                    {group.label}
                  </Caption>
                  <ul className="space-y-rhythm-sm">
          ...
          <div className="border-t border-border/30 pt-rhythm-md md:pt-rhythm-lg">
