  ...
  return (
    <main>
      <PageEditorialHero
        atmosphere="services"
        eyebrow="Services"
        title="Architecture advisory for sustainable enterprise frontend platforms."
        description="Al Marfa focuses on the architectural and governance thinking that frontend platforms require at scale. We work with engineering leadership on the systems, structures, and practices that make distributed frontend ownership sustainable."
      />
...
function EngagementModelSection() {
  return (
    <Section spacing="default" surface="raised">
      <Container size="content">
        <Stack gap="lg">
          <EditorialSectionIntro eyebrow="How We Work">
          ...
          <div className="mt-rhythm-lg border-t border-border pt-rhythm-lg">
            <Stack gap="lg">
